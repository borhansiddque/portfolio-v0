  ...
  return (
    <div className="max-w-7xl mx-auto mb-20">
      ...
      <div className="mt-8 flex flex-wrap gap-5">
        ...
        <TechButton icon={"https://img.icons8.com/?size=256&id=4PiNHtUJVbLs&format=png"} title={"Tailwind CSS"} link={"https://tailwindcss.com/"} />
        <TechButton icon={"https://img.icons8.com/?size=256&id=108784&format=png"} title={"JavaScript"} link={"https://learnjavascript.online/"} />
